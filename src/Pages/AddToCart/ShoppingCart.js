...
//    }
    ...
    return (
                 ...
                 <div className='container'>
           {
            ...
            <h6 className='mb-4 fs-5 text-center text-danger'>চেক-আউট সামারি</h6>
            ...
            <div className='text-center checkout-button mt-3 roundend'>
                <button className='btn text-center'>
                    <Link className='text-white' to='/shipping'>চেক আউট করতে এগিয়ে যান</Link>
                </button>
            </div>
            <div className='mt-3'>
           ...
           </div>:<div className='bg-dark p-5 text-center'>
                <h6 className='text-white fs-5 fw-bolder'>Your Cart is Empty</h6>
            <button className='text-center bg-danger text-white border-0 px-5 py-2 fs-5 rounded' onClick={() => navigate('/')}>Continue Shipping</button>
            </div>
