  ...
  return (
    <div>
      ...
      >
        ...
        <div className="d-flex  w-100 h-100 justify-between items-middle bg-white rounded cursor-pointer">
          <div className="w-100 position-relative px-5 py-4">
            <h2 className="font-semibold m-0 d-flex items-center">
