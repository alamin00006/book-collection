    ...
    return (
        <div className='container card-area bg-white p-4'>
             <div className='d-flex justify-content-between align-items-center mb-4'>
                ...
                <div className='text-center'>  <Link className='my-button text-black' to="/week-best-sale-all">
                আরও দেখুন
                </Link></div>
            </div>
            <div className='my-card-main my-card'>
            {
                    weekSales?.map((data, index)=> <Cart key={data._id} data={data} AddToCarts={AddToCarts}></Cart >) 
                }
