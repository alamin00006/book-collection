...
const Products3 = ({AddToCarts, carts}) => {
    ...
    return (
       ...
       {
            myProducts3.slice(0,5).map(( product3, index )=> <Product3 key={index} product3={product3} AddToCarts={AddToCarts} carts={carts}></Product3 >) 
        }
