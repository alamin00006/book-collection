   ...
   const handlePublicationAdd = async(e)=>{
    ...
    return (
        <div className='product-info '>
              <h2 className='text-center p-5 bg-danger text-white'>Publication Add</h2>
            <form onSubmit={handlePublicationAdd} className='category-form'>
                 <div className=''>
                       ...
                       <div>
                        ...
                        <input style={{width:"100%", height:'60px'}} className='bg-warning rounded text-white fw-bolder fs-5 mt-1' type="submit" value='Publication Add'/>
                       </div>
