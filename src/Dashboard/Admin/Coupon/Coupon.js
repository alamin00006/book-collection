...
const Coupon = () => {
   ...
   const handleCouponAdd = async(e)=>{
    ...
    try{
        const data = await axios.post('http://localhost:5000/api/v1/coupon-add',couponAdd);
        ...
        <div className='product-info '>
            ...
            <form onSubmit={handleCouponAdd} className='category-form'>
                 <div className=''>
                       ...
                       <div>
                         <input style={{width:"100%", height:'60px', border:'1px solid gray'}} type="text" name='couponCode' className='rounded fs-5' placeholder='Enter Coupon Code' />
